        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">SSB Terafiliasi</h2>
                </div>
             ...
             <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Data SSB Terafiliasi</h3>
                    <div class="col">
                        <a class="btn btn-primary mb-3" href="tambah_ssb.php"><i class="fa fa-plus-square "></i> Tambah Data SSB </a> 
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr align="center">
                                    <th scope="col">Nama SSB</th>
                                    <th scope="col">Pelatih</th>
                                    <th scope="col">Kel. Usia</th>
                                ...
                                <?php 
                                    ...
                                    while($d = mysqli_fetch_array($data)){
                                        ...
                                        <tr align="center">
                                            ...
                                            <td><?php echo $d['kel_usia']; ?></td>
                                            <td><?php echo $d['jadwal_hari']; ?></td>
                                            <td><?php echo $d['jadwal_jam']; ?></td>
                                            <td><a class="btn btn-primary" href="detail_ssb.php?profil=<?php echo $d['nama_club']; ?>"><span class="fas fa-align-justify"> </span></a></td>
