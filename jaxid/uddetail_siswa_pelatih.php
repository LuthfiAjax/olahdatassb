    ...
    <section class="about" id="about">
      <div class="container">
          ...
          <div>
            ...
            <div class="col-sm-6">
              <h3 class="text-center">Alamat Siswa</h3>
              <hr/>
              <h4 align="center"><?php echo $d['alamat_pemain']; ?></h4>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12 text-center">
              ...
              <hr />
              <h4 align="center">
                <a onclick="return confirm ('Yakin hapus <?php echo $d['nama_pemain'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Siswa" href="pelatih_hapus_siswa.php?hal=hapus&kd=<?php echo $d['nisn'];?>"><span class="fa fa-lg fa-trash"> </span>Hapus</a>
                <a onclick="return confirm ('Yakin Edit <?php echo $d['nama_pemain'];?>.?');" class="btn btn-sm btn-primary tooltips" data-placement="bottom" data-toggle="tooltip" title="Edit Siswa" href="pelatih_edit_siswa.php?hal=hapus&kd=<?php echo $d['nisn'];?>"><span class="fa fa-lg fa-edit"> </span>Edit</a>
              </h4>
            </div>
        </div>
      </div>
