    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="chat.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Room Pesan</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Daftar Kritik dan saran</h3>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td><?php echo $d['no_phone']; ?></td>
                                    <td><?php echo $d['pesan']; ?></td>
                                    <td><div id="thanks">
                                                <a onclick="return confirm ('Yakin hapus <?php echo $d['email'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Pesan" href="hapus_chat.php?hal=hapus&kd=<?php echo $d['id_pesan'];?>"><span class="fa fa-lg fa-trash"> </span></a></td>
                    ...
                    <hr>
                    <br>
                    <h3 class="fs-4 mb-3">Mutasi Pemain</h3>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th scope="col">SSB Asal</th>
                                    <th scope="col">SSB Tujuan</th>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td><?php echo $d['club_baru']; ?></td>
                                    <td><?php echo $d['alasan']; ?></td>
                                    <td><?php echo $d['proses']; ?></td>
                                    <td><div id="thanks">
                                                <a onclick="return confirm ('Yakin sudah memproses permintaan dari <?php echo $d['nama_club'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Pesan" href="hapus_mutasi.php?hal=hapus&kd=<?php echo $d['id_mutasi'];?>"><span class="fa fa-lg fa-trash"> </span></a></td>
