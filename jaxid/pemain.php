    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="pemain.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Data Siswa SSB</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3"> Data Siswa SSB</h3>
                    <div class="col">
                        <a class="btn btn-primary btn-sm mb-3" href="tambah_pemain.php"><i class="fa fa-plus-square "></i> Tambah Data Siswa SSB </a> 
                       <form class="example" method="POST" action="" style="margin:0px;max-width:300px">
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <a class="btn btn-sm btn-success tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Siswa" href="detail_siswa.php?detail=<?php echo $d['nisn']; ?>"><span class="fas fa-align-justify"> </span></a>
