    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="mutasi_siswa.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Data Mutasi Siswa SSB anda</h3>
                    <div class="col">
                        <?php 
                        $klub = $_SESSION['nama_club'];
                        ?>
                        <a class="btn btn-primary mb-3" href="mutasi_pengajuan.php?tambah=<?php echo $klub; ?>"><i class="fa fa-plus-square "></i> Ajukan Mutasi Siswa </a>
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                ...
                                <?php 
                                    $data = mysqli_query($koneksi,"select * from mutasi where nama_club = '$klub'");
