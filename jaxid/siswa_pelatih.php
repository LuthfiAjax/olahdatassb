    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="siswa_pelatih.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Seluruh Data Siswa SSB</h3>
                    <div class="col">
                        <?php 
                        $klub = $_SESSION['nama_club'];
                        ?>
                        <a class="btn btn-primary mb-3" href="tambah_pemain_pelatih.php?tambah=<?php echo $klub; ?>"><i class="fa fa-plus-square "></i> Tambah Data Siswa SSB </a>
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                ...
                                <?php 
                                    $data = mysqli_query($koneksi,"select * from pemain where nama_club = '$klub'");
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        <div>
                                            <a class="btn btn-sm btn-success tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Siswa" href="uddetail_siswa_pelatih.php?detail=<?php echo $d['nisn']; ?>"><span class="fas fa-align-justify"> </span></a>
